...
SECRET_KEY = 't9a5a7hxnx)vbm@q%8(l4pmmq2pps6+hk@b1#+0%en=kf#zu^t'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'kmj990929',
        'PASSWORD': 'dbswnalswn81!',
        'HOST': 'greenbubble-seoul-db.chbsgt128ost.ap-northeast-2.rds.amazonaws.com',
        'PORT':'5432',
    }
}
